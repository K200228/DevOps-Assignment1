        ...
        <Router>
          ...
          <Routes>
            ...
            <Route exact path='/Home' element={
              <Home
                name="Ismail Ahmed Ansari"
                bio="Exploring the depths of data science as a curious and analytical Brainy Bot, continuously honing my skills and expanding my knowledge to become a true Data Science Savvy. With a sharp Machine Mindset and a passion for innovation, 
      I am driven to push the boundaries of what's possible with data and models." />} />
